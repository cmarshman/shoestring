...
PLAID_CLIENT_ID='5f5043414c3aa5001162c49a' 
PLAID_SECRET= 'bff3465d3166f757d2464134f78efb'
...
httpClient.createPLink = () =>{
  return this ({method: 'post', url: '/api/create_link_token', function(request, response, next) {
   const configs = {
    'user': {
...
httpClient.FindAccessLink = () =>{
return this ({method: 'post', url: '/api/set_access_token', function(request, response, next) {
